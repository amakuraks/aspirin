...
3. If ANYTHING is unclear — ask ALL clarifying questions in **ONE message**.
4. **DO NOT generate any solution proposals yet.**
5. Only generate detail that helps the user make a decision (e.g., "Option A means X, Option B means Y — which do you prefer?").
6. Gate: Wait for user to answer.
...
2. **Lead with the best-practice / commonly-used recommendation.**
...
5. Gate: Wait for user to pick an option.
